...
public class pay5 : MonoBehaviour
{
    string city;
    ...
    string[] trop_arr = { "Caribbean Islands", "Tokyo"};
    int index;
    ...
    public void Score_up()
    {
        ...
        if (Risks.rt == 8)
        {
            index = Random.Range(0, trop_arr.Length);
            c.text = trop_arr[index] + "!";
            city = trop_arr[index];
            asset_in(city, Checkbox_9.TROPICAL, Checkbox_9.NO_TROPICAL);
        }
        if (Risks.rt == 9)
        {
            c.text = "Mumbai!";
            city = "Mumbai";
            asset_in(city, Checkbox_5.TERROR, Checkbox_5.NO_TERROR);
        }
    }
